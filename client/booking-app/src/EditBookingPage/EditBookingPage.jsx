...
class EditBookingPage extends React.Component {
  ...
  render() {
    ...
    const { booking, submitted, loading, status, role, providersLoading, users, inValidDate } = this.state;
        ...
        <div className="col-md-6 col-md-offset-3">
          ...
          <form name="form" onSubmit={this.handleSubmit}>
            <div className={'form-group' + (submitted && !booking.requestedOn || inValidDate ? ' has-error' : '')}>
              ...
              <Datetime value={moment(booking.requestedOn)} timeConstraints={timeConstraints} isValidDate={valid} onChange={this.handleDateTime} />
